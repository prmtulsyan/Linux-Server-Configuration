...
You can visit http://13.229.107.7/ or http://13.229.107.7.xip.io for the website deployed.
...
- To connect to the instance via the terminal: `ssh -i ~/.ssh/lightsail_key.rsa ubuntu@13.229.107.7`,
  where `13.229.107.7` is the public IP address of the instance.
